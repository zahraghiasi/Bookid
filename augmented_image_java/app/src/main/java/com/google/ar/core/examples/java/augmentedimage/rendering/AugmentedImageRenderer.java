...
public class AugmentedImageRenderer {
    ...
    private final ObjectRenderer model1 = new ObjectRenderer();
    ...
    public void createOnGlThread(Context context) throws IOException {
        ...
        model1.createOnGlThread(
                context, "models/shazdehv9.obj","models/shazdehv9.mtl");
        model1.setMaterialProperties(1.0f, 3.5f, 1.0f, 6.0f);
        model1.setBlendMode(BlendMode.AlphaBlending);
    ...
    public void draw(
        ...
        Pose[] localBoundaryPoses = {
                ...
                Pose.makeTranslation(
                        -0.5f * augmentedImage.getExtentX(),
                        0.0f,
                        0.5f * augmentedImage.getExtentZ()) // model
        };
        ...
        model1.updateModelMatrix(modelMatrix, scaleFactor);
        model1.draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);
    }
